...
return [
	...
	'categories'  => [ 'bs-grid' ],
	'content'     => <<<'HTML'
<!-- wp:group {"metadata":{"name":"bs Grid - Accordion","categories":["bs-grid"],"patternName":"bs-grid/accordion"},"className":"bs-accordion mb-3 hide-wp-block-classes bs-toc-hide","layout":{"type":"default"}} -->
<div class="wp-block-group bs-accordion mb-3 hide-wp-block-classes bs-toc-hide"><!-- wp:group {"metadata":{"name":"accordion"},"className":"accordion","layout":{"type":"default"}} -->
<div class="wp-block-group accordion"><!-- wp:group {"metadata":{"name":"accordion-item"},"className":"accordion-item","layout":{"type":"default"}} -->
